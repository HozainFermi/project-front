...
export default function MainLayout() {
  ...
  const menuItems = [
    { path: '/user', label: 'Главная', icon: FaHome },
    { path: '/user/profile', label: 'Профиль', icon: LuUser },
    { path: '/user/meters', label: 'Счётчики', icon: LuGauge },
    { path: '/user/requests', label: 'Заявки', icon: LuClipboardList },
    { path: '/user/news', label: 'Новости', icon: LuBuilding },
    { path: '/user/settings', label: 'Настройки', icon: LuSettings },
  ];
