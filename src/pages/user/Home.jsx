      ...
      <SimpleGrid columns={{ base: 1, lg: 2 }} gap={6}>
        <Box bg="white" p={4} rounded="lg" shadow="sm">
          ...
          <VStack align="stretch" gap={3}>
            ...
            <Button as={RouterLink} to="/user/news" size="sm" variant="ghost">
              Все новости →
            </Button>
          </VStack>
        </Box>
        ...
        <Box bg="white" p={4} rounded="lg" shadow="sm">
          ...
          <SimpleGrid columns={2} gap={3}>
            <Button as={RouterLink} to="/user/meters" h="60px" colorPalette="teal" variant="outline">
              Передать показания
            </Button>
            <Button as={RouterLink} to="/user/requests/new" h="60px" colorPalette="teal" variant="outline">
              Создать заявку
            </Button>
            <Button as={RouterLink} to="/user/news" h="60px" colorPalette="teal" variant="outline">
              Новости
            </Button>
            <Button as={RouterLink} to="/user/profile" h="60px" colorPalette="teal" variant="outline">
              Настройки профиля
            </Button>
          </SimpleGrid>
        </Box>
